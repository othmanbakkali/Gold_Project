export const translations = {
  "fr": {
    ...
    "features": [
      {
        "title": "Fiable",
        "desc": "Données précises de sources vérifiées"
      },
      {
        "title": "Immédiat",
        "desc": "Mise à jour instantanée des prix"
      },
      {
        "title": "Transparent",
        "desc": "Des données claires pour tous"
      },
      {
        "title": "Multi-plateforme",
        "desc": "Disponible sur mobile, web, TV"
      },
      {
        "title": "Service Pro",
        "desc": "Support dédié aux professionnels"
      }
    ],
    "karats": {
      "k14": "14 Carats",
    ...
    "hp": {
      ...
      "subtitle": "── Prix de l'or quotidien au Maroc ──",
      "startingFrom": "à partir de",
      "currency": "MAD/gramme",
      "dayMode": "Mode Jour",
      "nightMode": "Mode Nuit",
      "fullChartMenu": "Graphique complet",
      "musicOn": "Musique On",
      "musicOff": "Musique Off",
      "tvDisplay": "Écran TV",
      "brandAr": "الفدرالية المغربية للصياغين",
      "brandFr": "FÉDÉRATION MAROCAINE DES BIJOUTIERS",
      "lastUpdate": "Dernière mise à jour",
      "tvLink": "📺 Écran TV",
      "chartTitle": "Évolution du Prix (18K)",
      "current": "Actuel",
      "min": "Min",
      "max": "Max",
      "avg": "Moyenne",
      "fullChartBtn": "Voir le graphique complet",
      "mostTraded": "Le plus négocié",
      "currencyShort": "MAD/g",
  ...
  "en": {
    ...
    "features": [
      {
        "title": "Reliable",
        "desc": "Accurate data from trusted sources"
      },
      {
        "title": "Instant",
        "desc": "Real-time price updates"
      },
      {
        "title": "Transparent",
        "desc": "Clear and transparent data for all"
      },
      {
        "title": "Anywhere",
        "desc": "Available on Mobile, Web, and Smart TV"
      },
      {
        "title": "Pro Support",
        "desc": "Dedicated support for professionals"
      }
    ],
    "karats": {
      "k14": "14 Karat",
    ...
    "hp": {
      "title": "18K Raw Gold Price",
      "subtitle": "── Daily Gold Prices in Morocco ──",
      "startingFrom": "starting from",
      "currency": "MAD/gram",
      "dayMode": "Day Mode",
      "nightMode": "Night Mode",
      "fullChartMenu": "Full Chart",
      "musicOn": "Music On",
      "musicOff": "Music Off",
  ...
  "ar": {
    ...
    "features": [
      {
        "title": "موثوق",
        "desc": "بيانات دقيقة من مصادر موثوقة ومعتمدة"
      },
      {
        "title": "فوري",
        "desc": "تحديث الأسعار بشكل لحظي وفوري"
      },
      {
        "title": "شفاف",
        "desc": "معطيات واضحة وشفافة للجميع"
      },
      {
        "title": "متوفر في كل مكان",
        "desc": "على جميع الأجهزة (موبايل، ويب، تلفاز ذكي)"
      },
      {
        "title": "خدمة احترافية",
        "desc": "دعم ومواكبة لجميع المهنيين"
      }
    ],
    "karats": {
      "k14": "عيار 14",
    ...
    "hp": {
      ...
      "subtitle": "── أسعار الذهب اليومية في المغرب ──",
      "startingFrom": "إنطلاقا من",
      "currency": "درهم/غرام",
      "dayMode": "الوضع النهاري",
      "nightMode": "الوضع الليلي",
      "fullChartMenu": "الرسم البياني الكامل",
      "musicOn": "موسيقى مفعلة",
      "musicOff": "موسيقى معطلة",
      "tvDisplay": "شاشة TV",
      "brandAr": "الفدرالية المغربية للصياغين",
      "brandFr": "FÉDÉRATION MAROCAINE DES BIJOUTIERS",
      "lastUpdate": "التحديث الأخير",
      "tvLink": "📺 عرض شاشة التلفزيون",
      "chartTitle": "تطور سعر الذهب (عيار 18)",
      "current": "الحالي",
      "min": "الأدنى",
      "max": "الأعلى",
      "avg": "المتوسط",
      "fullChartBtn": "عرض الرسم البياني الكامل",
      "mostTraded": "الأكثر تداولا",
      "currencyShort": "درهم/غ",
      "downloadApp": "تحميل التطبيق للموبايل"
    },
    "tv": {
      "title": "سعر الذهب الخام عيار 18 ",
      "updatedAt": "آخر تحديث:",
  ...
  "es": {
    ...
    "features": [
      {
        "title": "Confiable",
        "desc": "Datos precisos de fuentes fiables"
      },
      {
        "title": "Inmediato",
      ...
      {
        "title": "Transparente",
        "desc": "Datos claros y transparentes para todos"
      },
      {
        "title": "Accesible",
        "desc": "Disponible en Móvil, Web y TV"
      },
      {
        "title": "Soporte Pro",
        "desc": "Soporte dedicado para profesionales"
      }
    ],
    "karats": {
      "k14": "14 Quilates",
    ...
    "hp": {
      ...
      "subtitle": "── Precios diarios del oro en Marruecos ──",
      "startingFrom": "a partir de",
      "currency": "MAD/gramo",
      "dayMode": "Modo Día",
      "nightMode": "Modo Noche",
      "fullChartMenu": "Gráfico completo",
      "musicOn": "Música On",
      "musicOff": "Música Off",
      ...
      "tvLink": "📺 Pantalla TV",
      "chartTitle": "Evolución del Precio (18K)",
      "current": "Actual",
      "min": "Mín",
      "max": "Máx",
      "avg": "Promedio",
      "fullChartBtn": "Ver Gráfico Completo",
      "mostTraded": "Más negociado",
      "currencyShort": "MAD/g",
