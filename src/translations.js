export const translations = {
  fr: {
    tv: {
      title: "Prix de vente de Bijoux 18K",
      ...
      pricePrefix: "Prix Actuel :",
      priceSuffix: "Dirhams/g + <b class='animate-service'>Main d'oeuvre</b>"
    },
    admin: {
  ...
  en: {
    tv: {
      ...
      pricePrefix: "Current price:",
      priceSuffix: "Dirhams/g + <b class='animate-service'>Workforce</b>"
    },
    admin: {
      title: "Administration",
      backToTv: "Back to TV",
  ...
  ar: {
    tv: {
      title: "سعر بيع المجوهرات و الحلي 18 قيراط",
      updatedAt: "آخر تحديث:",
